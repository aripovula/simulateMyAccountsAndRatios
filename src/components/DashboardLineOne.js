...
export default class DashboardLineOne extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        };
        ...
        return (
            <div id="container">
                <div id="left">
                    ...
                    <span className="dtitle">market share</span>
                    <ReChartPieMarket />
                </div>
                <div id="middle">
                    <span className="verIndentFive"></span>
                    <span className="dtitle">geographic presence</span>
                    <ReChartPieChart />
                </div>
                <div id="right">
                    <span className="verIndentFive"></span>
                    <span className="dtitle">monthly KPI status</span>
